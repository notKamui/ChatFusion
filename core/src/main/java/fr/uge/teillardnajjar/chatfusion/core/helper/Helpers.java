package fr.uge.teillardnajjar.chatfusion.core.helper;
...
/**
 * This class contains helper methods to know the state
 * of a {@link Selector} and {@link SelectionKey}
 */
public class Helpers {

    /**
     * Prints the state of the keys of a {@link Selector}
     *
     * @param selector the selector to print the keys of
     */
    ...
    /**
     * Prints the state of a selected key ({@link SelectionKey})
     *
     * @param key the key to print the state of
     */
